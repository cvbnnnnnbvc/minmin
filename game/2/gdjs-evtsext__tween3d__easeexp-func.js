...
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = Math.exp(gdjs.evtTools.tween.ease(eventsFunctionContext.getArgument("Easing"), Math.log(eventsFunctionContext.getArgument("InitialValue")), Math.log(eventsFunctionContext.getArgument("TargetedValue")), eventsFunctionContext.getArgument("Weighting"))); }}}
